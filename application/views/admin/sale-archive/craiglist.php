    		<div class="table-responsive">
					<table class="table-sm table-hover text-nowrap table-bordered" cellspacing="0" width='100%' style='font-size: 13px;'>
						...
						<tbody>
						<form name='frmDeleteResults' id='frmDeleteResults' action='<?php echo site_url("admin/salerecordsarchive/delete"); ?>' method='post'>
						...
						<tr class='BOT_<?php echo $jobListing['search_id']; ?>'>                                   
							...
							<td class="text-nowrap">
								<a href="#"><i title="View Details" id='jid_<?php echo $jobListing['result_id']; ?>' class=" icon-blue viewJob fa fa-eye"></i</a>
