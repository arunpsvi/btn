        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
					...
					<?php if($this->session->userdata('role')=='ADMIN' || $this->session->userdata('role')=='SALESADMIN' ){ ?>
						<li><a href="javascript:void(0);" class="waves-effect"><i class="fa fa-cogs fa-fw"></i> <span class="hide-menu">Sales Management<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<!--<li> <a href="<?php echo site_url('admin/keywords') ?>">Manage Keywords</a></li>-->
								<?php //if($this->session->userdata('role')=='ADMIN'){ ?>
									<li> <a href="<?php echo site_url('admin/bots') ?>">Manage Bots</a></li>
									
								<?php //} ?>
								<!--<li> <a href="<?php echo site_url('admin/scrape') ?>">Scrape Data</a></li>-->
								<li> <a href="<?php echo site_url('admin/salerecords') ?>">Sales Records</a></li>
								<li> <a href="<?php echo site_url('admin/salerecordsarchive') ?>">Archived records</a></li>
							</ul>
						</li>
					<?php } ?>
					...
					<?php if($this->session->userdata('role')=='ADMIN'){ ?>
						<li><a href="javascript:void(0);" class="waves-effect"><i class="fa icon-user fa-fw"></i> <span class="hide-menu">User Management<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="<?php echo site_url('admin/user/all_user_list') ?>" class="waves-effect"> <span class="hide-menu">Users</span></a></li>
								<li><a href="<?php echo site_url('admin/user/userlog') ?>" class="waves-effect"> <span class="hide-menu">Users Log</span></a></li>
								
							</ul>
						</li>
						<li><a href="javascript:void(0);" class="waves-effect"><i class="fa fa-cog fa-fw"></i> <span class="hide-menu">Diagnostic Tool<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="<?php echo site_url('admin/diagnostictools/proxy') ?>" class="waves-effect"> <span class="hide-menu">Proxy</span></a></li>
								<li><a href="<?php echo site_url('admin/diagnostictools/salesBots') ?>" class="waves-effect"> <span class="hide-menu">Sales</span></a></li>
								<li><a href="<?php echo site_url('admin/diagnostictools/jobsBots') ?>" class="waves-effect"> <span class="hide-menu">Jobs</span></a></li>							
							</ul>
						</li>
						...
						<li><a href="<?php echo site_url('admin/reject') ?>" class="waves-effect"><i class="fa fa-ban fa-fw"></i> <span class="hide-menu">Reject Management</span></a></li>
					<?php } ?>
