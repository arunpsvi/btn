...
.ms-options{
	...
	<?php
		...
		$showHideArray['shdiv_Emails']='Emails';
		$showHideArray['shdiv_twitterURL']='Twitter';
		$showHideArray['shdiv_facebookURL']='Facebook';
		ksort($showHideArray);
					...
					<table class="table-sm table-hover text-nowrap table-bordered" cellspacing="0" width='100%' style='font-size: 13px;'>
						<thead >
							<tr  class="bg-info">                                   
								...
								<th class='font-weight-bold text-white shdiv_Emails'>Emails</th>
								<th class='font-weight-bold text-white shdiv_twitterURL'>Twitter</th>
								<th class='font-weight-bold text-white shdiv_facebookURL'>Facebook</th>
						...
						<?php } ?>
							...
							<td class='shdiv_DecisionMaker'><input type='text' class="class-decision_maker" name='<?php echo 'decisionmaker_'.$result_id; ?>' id='<?php echo 'decisionmaker_'.$result_id; ?>' value='<?php echo $jobListing['decision_maker']; ?>' <?php echo $readonlyForEndUser; ?> /></td>
							<?php //} ?>
							...
							<?php 
								$conpanyUrl=$jobListing['companyUrl'];
								if(!empty($jobListing['companyUrl'])){
									$conpanyUrl='<a target="_blank" href="'.$jobListing['companyUrl'].'">'.$jobListing['companyUrl']."</a>";
								}

								$companyWebsite=$jobListing['companyWebsite'];
								if(!empty($jobListing['companyWebsite'])){
									$companyWebsite='<a target="_blank" href="'.$jobListing['companyWebsite'].'">'.$jobListing['companyWebsite']."</a>";
								}
								
							?>
							<td class='shdiv_Profile_url'><?php echo $conpanyUrl; ?></td>
							
							<td class='shdiv_Company_url'><?php echo $companyWebsite; ?></td>
							...
							<td class='shdiv_Emails'><?php echo $jobListing['emails']; ?></td>						
							<td class='shdiv_twitterURL'><?php echo $jobListing['twitterURL']; ?></td>						
							<td class='shdiv_facebookURL'><?php echo $jobListing['facebookURL']; ?></td>						
						</tr>
						<?php } ?>
						</form>	
						</tbody>
