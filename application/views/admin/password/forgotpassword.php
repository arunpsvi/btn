  ...
  <div class="login-box login-sidebar" >
    <div class="white-box" style="margin-top:80px;border:1px solid red"> 
               ...
               <div align="center"> 
				...
				Welcome to <strong style="color:green">Job Post Scraper</strong>. <br><br><br>

				<p class='text-danger text-bold'><strong>Please enter new password with secret key you received on your registered email.</strong></p>
					...
					<div align="center">
						...
						<br><br>
						<form class="form-horizontal form-material" id="login-form" action="<?php echo site_url('forgotpassword/updatePassword'); ?>" method="post"> 
						...
						<div class="form-group ">
							<div class="col-xs-12">
								<input class="form-control" type="password" name="conformpassword" value="" required="" placeholder="Conform Password" style="width:100%" >
							</div>
						</div>

					<div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="secretkey" id="secretkey" value="" required="" placeholder="Secret Key" style="width:100%">
                        </div>
                    </div>
