			...
			<div class="panel-wrapper collapse in" aria-expanded="true">
				<div class="panel-body">
					...
					<input style="display:none" type="text" name="fakeusernameremembered"/>
						...
						<div class="form-body">
							<h3 class="box-title">Create New Sale Bot</h3>
							<hr>
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label required"><b>Bot name</b></label>
								...
								<div class="col-md-2 "><br>
									<div class="checkbox checkbox-info">
										<input name='scrape_all' id="scrape_all" type="checkbox" <?php if(!empty($scrape_all) && $scrape_all=='Y') { echo "checked"; } ?>>
										<label for="scrape_all"><b>Scrape All</b></label>								
									</div>
								</div>
