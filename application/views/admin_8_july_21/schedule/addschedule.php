...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			<h3 class="box-title">Schedule scraper</h3>
				<hr>
				...
				<div class="row">					
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" name="monday" id="monday" checked>
							<label class="form-check-label m-l-20" for="monday">Monday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="tuesday" name="tuesday" checked>
							<label class="form-check-label m-l-20" for="tuesday">Tuesday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="wednesday" name="wednesday" checked>
							<label class="form-check-label m-l-20" for="wednesday">Wednesday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="thursday" name="thursday" checked>
							<label class="form-check-label m-l-20" for="thursday">Thursday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="friday" name="friday" checked>
							<label class="form-check-label m-l-20" for="friday">Friday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="saturday" name="saturday" checked>
							<label class="form-check-label m-l-20" for="saturday">Saturday</label>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="sunday" name="sunday" checked>
				...
				<table class="table-sm table-hover table-bordered" cellspacing="0" width='100%'>
						<thead >
							<tr  class="bg-info">                                   
								...
								<th  class='font-weight-bold text-white'>End date</th>
						...
						$days=$schedule['no_of_days']-1;
						?>
						<tr >                                   
							<td><?php echo $schedule['start_date']; ?></td>
							<td><?php echo $schedule['no_of_days']; ?></td>
							<td><?php echo date('Y-m-d', strtotime($schedule['start_date'] .' +'.$days.' day')); ?></td>
							<td>
								<?php 
									$suffix='';
