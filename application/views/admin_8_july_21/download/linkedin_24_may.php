					...
					<table class="table-sm table-hover text-nowrap table-bordered" cellspacing="0" width='100%' style='font-size: 13px;'>
						<thead >
							<tr  class="bg-info">                                   
								...
								<th class='font-weight-bold text-white'>Description</th>
								
								
								<!-- 4 -->
								
								<th class='font-weight-bold text-white'>Applications</th>
								<th class='font-weight-bold text-white'>Organization</th>
								<th class='font-weight-bold text-white'>Profile url</th>											
								<th class='font-weight-bold text-white'>Employement Type</th>											
								<th class='font-weight-bold text-white'>Seniority level</th>											
								<th class='font-weight-bold text-white'>Industries</th>											
								<th class='font-weight-bold text-white'>Job function</th>
								<th class='font-weight-bold text-white'>Company url</th>		
								<th class='font-weight-bold text-white'>Employees</th>		
								<th class='font-weight-bold text-white'>Employees on linkedin</th>
						...
						<tr >    
							...
							<td><?php echo $jobListing['description']; ?></td>

							<!--4 -->

							<td><?php echo $jobListing['applications']; ?></td>
							<td><?php echo $jobListing['organization']; ?></td>
							<td><?php echo $jobListing['companyUrl']; ?></td>
							<td><?php echo $jobListing['employementType']; ?></td>
							<td><?php echo $jobListing['seniorityLevel']; ?></td>
							<td><?php echo $jobListing['industries']; ?></td>
							<td><?php echo $jobListing['jobFunction']; ?></td>
							<td><?php echo $jobListing['companyWebsite']; ?></td>
							<td><?php echo $jobListing['employees']; ?></td>
							<td><?php echo $jobListing['employeesOnLinkedin']; ?></td>
							...
							<td><?php echo $jobListing['emails']; ?></td>-->
